...
urlpatterns = patterns('',
    ...
    url(r'^finalizar_compra/(?P<pagamento>[\w ]+)/$', 'EntregAqui.delivery.views.finalizar_compra'),
    url(r'^finalizar_compra/(?P<pagamento>[\w ]+)/(?P<observacao>[\w ]+)/$', 'EntregAqui.delivery.views.finalizar_compra'),
    url(r'^fale_conosco/$', 'EntregAqui.delivery.views.exibir_painel_fale_conosco'),
    url(r'^painel/historico/$', 'EntregAqui.delivery.views.painel_historico'),
    ...
    url(r'^entenda_preguica/$', 'EntregAqui.delivery.views.exibir_ajuda'),
    url(r'^visualizar_carrinho/$', 'EntregAqui.delivery.views.exibir_carrinho'),
    ...
    url(r'^(?P<cidade>[\w ]+)/(?P<categoria>[\w ]+)/(?P<loja>[\w ]+)/pagamento/$', 'EntregAqui.delivery.views.iniciar_pagamento'),
